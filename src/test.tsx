  ...
  render() {
    return (
      <div>
        ...
        >
          <vf-textarea
            field={this.formFields.textarea}
            onEventChange={() => {
              this.formFields = {
                ...this.formFields,
                textarea: this.formFields.textarea.render(),
              };
            }}
          ></vf-textarea>
          <vf-datepicker
            field={this.formFields.datepicker}
            onEventChange={() => {
              this.formFields = {
                ...this.formFields,
                datepicker: this.formFields.datepicker.render(),
              };
            }}
          ></vf-datepicker>

          <button type="submit">Submit type 2</button>
          <button type="reset">Reset type 2</button>
        </vf-form>
