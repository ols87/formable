...
| `formFields` | --        |             | `FormProperty`       | `{     textarea: Formable.textarea({       view: {         id: "textarea",         label: "Textarea",         required: true,         rows: 3,       },     }),     editor: Formable.editor({       view: {         id: "editor",         label: "Editor",         required: true,       },     }),   }`                                                                                                                                                                                                                              |
